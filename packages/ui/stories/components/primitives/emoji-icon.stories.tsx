      ...
      <div>
        ...
        <div className="grid grid-cols-6 gap-4">
          {[
            ...
            <EmojiIcon key={index} emoji={emoji} size={32} />
          ))}
        </div>
      </div>
    </div>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-6">
        <div className="text-center">
          ...
          <p className="mt-2 text-xs">固定标签 (14px)</p>
        </div>
        <div className="text-center">
          <EmojiIcon emoji="🎨" size={18} />
          <p className="mt-2 text-xs">导航 (18px)</p>
        </div>
        <div className="text-center">
          <EmojiIcon emoji="🎨" size={30} />
          <p className="mt-2 text-xs">普通头像 (30px)</p>
        </div>
        <div className="text-center">
          <EmojiIcon emoji="🎨" size={60} />
          <p className="mt-2 text-xs">大头像 (60px)</p>
        </div>
      </div>
    </div>
  )
