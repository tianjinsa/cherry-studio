...
# ISO 29500 Strict binds the same elements to a second namespace family. The format modules match the
# Transitional URIs literally, so a Strict package is out of scope — see reject_strict_ooxml below.
